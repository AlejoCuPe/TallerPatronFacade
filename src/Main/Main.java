...
public class Main {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        int sesion = generarNum();
        String tipoU = proxy.buscar(usuario, password);
        System.out.print(sesion);

        Fachada f = Fachada.getInstance();
        f.iniciarSesion(usuario, password, sesion);
        ...
        do {
            ...
            if (!f.iniciarSesion(usuario, password, sesion)) {
                ...
                Opcion = Integer.parseInt(f.menu(tipoU));
                if ("1".equals("1")) {
                    do {
                        ...
                        switch (Opcion) {
                            ...
                            case 1:
                                ...
                                f.crearRuta(hora, origen, destino, date, cupos, tarifa, (Usuario) f.buscarUsuario(usuario, password));
                                int elegir = 0;
                                do {
                            ...
                            case 1:
                                ...
                                if ("Rutas \n".equals(mostrar)) {
                                    ...
                                    if (probar == 0) {
                                        ...
                                        f.crearReserva(cupos, f.buscarRuta1(id), (Usuario) f.buscarUsuario(usuario, password));
