 ...
 * @author Andrés
 */
public class ModificarCalle1 extends javax.swing.JFrame {

    /**
     * Creates new form EliminarCalle
     */
    public ModificarCalle1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Escriba aquí el número de la calle que desea modificar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarCalle1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarCalle1().setVisible(true);
            }
        });
    }
