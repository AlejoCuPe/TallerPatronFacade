 ...
 * @author Andrés
 */
public class MostrarCalles extends javax.swing.JFrame {

    /**
     * Creates new form EliminarCalle
     */
    public MostrarCalles() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Muestra de Calles");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarCalles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarCalles().setVisible(true);
            }
        });
    }
